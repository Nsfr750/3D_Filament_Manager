...
LANGUAGES = {
    'en': {
        ...
        'app_title': '3D Filament Manager',
        'if_you_find_useful': 'if you find useful',
        'your_contribution_helps': 'your contribution helps',
        'sponsor': 'Sponsor',
    ...
    'it': {
        ...
        'app_title': '3D Filament Manager',
        'if_you_find_useful': 'se lo trovi utile',
        'your_contribution_helps': 'un tuo contributo può aiutare',
        'sponsor': 'Sponsorizza',
